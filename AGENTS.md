...
## 16. Estado y progreso

El estado del proyecto (implementado, aprendizajes y pendientes) se registra **por sesión**
en **`docs/sessions/<fecha>-progression.md`** (formato `YYYY-MM-DD`). Consulta el más
reciente para ver dónde se quedó el trabajo.
